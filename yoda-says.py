...
#### GMAIL CREDS ######
GUSERNAME = "GMAIL_USER_ID"
GPASSWORD = "YOU_KNOW_IT"
RESOURCE = "gmail.com"

#### Twitter Creds ####
TUSER="TWITTER_USER_NAME"
...
class Yoda:
    ...
    def gstat(self):
        ...
        cl.send(Iq('set','google:shared-status', payload=[
                                                          ...
                                                          Node('status',payload=[self.status])
                                                          ]))
        cl.disconnect() 
    ...
    def twit(self):
        ...
        tapi.update_status(self.status)
